...
angular.module("ngPlaceholders", []).factory("PlaceholderTextService", function() {
        function a(a, b) {
            ...
            link: function(b, c, d, e) {
                angular.forEach(c.find("input, textarea"), function(b) {
                    switch (elem = angular.element(b), b.type) {
                        case "textarea":
                            b.bla = "hi", elem.val(a.createParagraphs(1, 4));
                            break;
                        case "text":
...
fsm.directive("fsmStickyHeader", function() {
        return {
            ...
            link: function(a, b, c, d) {
                ...
                0 == l.length && (l = $(window)), l.scroll(h).trigger("scroll"), l.resize(h)
            }
        }
        ...
        return {
            ...
            link: function(a, b, c, d) {
                function e() {
                    $("body").toggleClass("fsm-menu-toggle"), f(), setTimeout(f, 50)
                }
    ...
    }), fsm.directive("fsmBigData", function(a) {
        return {
            restrict: "AE",
            scope: !0,
            replace: !1,
                ...
                b.sortTypes = q, f(b, function(a, d) {
                    ...
                    function s() {
                        var a = $(window).scrollTop(),
                            b = $(document).height(),
                            c = $(window).height();
                        scrollPercent = a / (b - c), scrollPercent > .98 && d.$apply(e)
                    }
                    c.append(a), d[i] = o, p.scroll(s).trigger("scroll"), b.$parent.$watchCollection(l, function(a) {
                        a && (m = a, j())
                    }), b.addSortColumn = f
                })
            }
        ...
        return {
            ...
            link: function(b, c, d) {
                function e() {
                    ...
                    var a = "md-sort";
                    "Ascending" === b.$parent.sortTypes[i] ? a = "md-arrow-drop-down" : "Descending" === b.$parent.sortTypes[i] && (a = "md-arrow-drop-up"), h.addClass(a)
                }
                var f = c,
                    g = d.fsmSort,
                    h = angular.element(a);
                ...
                f.css({
                    ...
                    i++, i == b.$parent.sortTypes.length && (i = 0), b.$apply(b.$parent.addSortColumn(g, i)), e()
                })
            }
        }
    }),
...
angular.module("app.constants", []).constant("APP", {
    ...
    a.includeSpinner = !1, a.latencyThreshold = 1
}]).config(["$datepickerProvider", function(a) {
...
}]).config(["$timepickerProvider", function(a) {
    angular.extend(a.defaults, {
        timeFormat: "HH:mm",
...
}), app.factory("todoService", ["localStorageService", "$rootScope", "$filter", function(a, b, d) {
    function e(c) {
        this.$scope = c, this.todoFilter = {}, this.activeFilter = 0, this.input = angular.element("#todo-title"), this.filters = [{
            title: "All",
            method: "all"
        }, {
            title: "Active",
        ...
        }, a.set("todos", todos)), a.bind(this.$scope, "todos"), this.completedTodos = function() {
            return d("filter")(this.$scope.todos, {
                done: !1
            })
    ...
    return e.prototype.saveTodo = function(a) {
        ...
        b.$broadcast("todos:count", this.count())
...
}]), app.controller("MainController", ["$scope", "$animate", "localStorageService", "todoService", "$alert", "$timeout", function(a, b, c, d, e, f) {
    "undefined" == typeof browser_old && (initRipplesWithArrive(), $(document).arrive(".navbar-toggle", function() {
        $(this).sideNav({
            menuWidth: 260,
            closeOnClick: !0
        })
    })), a.theme_colors = ["pink", "red", "purple", "indigo", "blue", "light-blue", "cyan", "teal", "green", "light-green", "lime", "yellow", "amber", "orange", "deep-orange"], service = new d(a), a.todosCount = service.count(), a.$on("todos:count", function(c, d) {
        ...
        color: "theme-orange",
        template: "theme-template-blue"
    }, c.set("theme", theme)), c.bind(a, "theme");
    var g = e({
        title: "Welcome to Mater V2",
    ...
    }, 1750), a.showIntroduction = function() {
        g.show()
    }
}]), app.controller("DashboardController", ["$window", "$scope", "$rootScope", "$interval", "colorService", function(a, b, c, d, e) {
    ...
    createInterval = function() {
        ...
        angular.isDefined(g) && (d.cancel(g), g = void 0)
    }, g = createInterval();
...
}]), app.controller("ChartsController", ["$scope", "$interval", "colorService", function(a, b, c) {
    ...
    }, 2e3), a.$on("$destroy", function() {
        angular.isDefined(interval) && (b.cancel(interval), interval = void 0)
    })
}]), app.controller("ColorsController", ["$scope", function(a) {
...
}]), app.controller("ListsController", ["$scope", "$routeParams", "$http", function(a, b, c) {
...
}]), app.controller("FullMapController", ["$scope", "$rootScope", "uiGmapIsReady", function(a, b, c) {
    a.map = {
        center: {
            latitude: 45,
            longitude: -73
        ...
        zoom: 8,
        control: {}
    }, b.isFullPageMap = !0, a.$on("$destroy", function() {
        b.isFullPageMap = !1
    }), c.promise(1).then(function(b) {
        b.forEach(function(b) {
            a.map.control.refresh()
        })
    })
}]), app.controller("BasicMapController", ["$scope", function(a) {
    a.map = {
        center: {
            latitude: 45,
            longitude: -73
...
}]), app.controller("ClickableMapController", ["$scope", function(a) {
    a.map = {
        center: {
            latitude: 40.399516,
            longitude: -22.703348
...
}]), app.controller("SearchableMapController", ["$scope", "uiGmapGoogleMapApi", function(a, b) {
    a.map = {
        center: {
            latitude: 40.399516,
            longitude: -22.703348
        ...
        a.searchFor = function(c) {
            geocoder = new b.Geocoder, geocoder.geocode({
                address: c
            }, function(c, d) {
...
}]), app.controller("ZoomableMapController", ["$scope", function(a) {
    a.zoomed_from_slider = !1, a.map = {
        center: {
            latitude: 52.369371,
            longitude: 4.894494
        },
        control: {},
        events: {
            zoom_changed: function(b, c, d) {
                a.zoomed_from_slider === !1 ? (zoom = a.getMapInstance().getZoom(), $("#slider").val(zoom)) : a.zoomed_from_slider = !1
            }
        },
        zoom: 6
    }, $("#slider").on({
        slide: function(b, c) {
            a.zoomed_from_slider = !0, a.getMapInstance().setZoom(parseInt(c))
        }
    }), a.getMapInstance = function() {
        return a.map.control.getGMap()
    }
}]), app.controller("VectorMapController", ["$scope", "$interval", function(a, b) {
    a.datamap = {
        US: 3,
        IT: 80,
        FR: 10,
        ...
        latLng: [52.369371, 4.894494],
        name: "Amsterdam"
    }, {
        latLng: [40.712942, -74.005774],
        name: "New York"
    }, {
        latLng: [41.385196, 2.173315],
        name: "Barcelona"
    }, {
        latLng: [37.764355, -122.451954],
        name: "San Francisco"
    }, {
        latLng: [41.9, 12.45],
        name: "Vatican City"
...
}]), app.controller("FormsController", ["$scope", "bootstrap3ElementModifier", function(a, b) {
...
}]), app.controller("UploadController", ["$scope", "Upload", "$timeout", function(a, b, c) {
...
}]), app.controller("TablesBasicController", ["$scope", "PlaceholderTextService", function(a, b) {
    a.settings = {
        singular: "Item",
        plural: "Items",
        cmd: "Add"
...
}]), app.controller("TablesDataController", ["$scope", "PlaceholderTextService", "ngTableParams", "$filter", function(a, b, c, d) {
    ...
    a.data = e, a.tableParams = new c({
        ...
        getData: function(a, b) {
            var c = b.filter().search,
                f = [];
            f = c ? e.filter(function(a) {
                return a.firstname.toLowerCase().indexOf(c) > -1 || a.lastname.toLowerCase().indexOf(c) > -1
            }) : e, f = b.sorting() ? d("orderBy")(f, b.orderBy()) : f, a.resolve(f.slice((b.page() - 1) * b.count(), b.page() * b.count()))
        }
    })
}]), app.controller("CrudController", ["$scope", "$window", "$aside", "PlaceholderTextService", function(a, b, c, d) {
    a.settings = {
        singular: "Item",
        plural: "Items",
        cmd: "Add"
...
}]), app.controller("TodoController", ["$scope", "todoService", function(a, b) {
